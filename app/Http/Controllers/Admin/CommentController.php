...
class CommentController extends Controller
{
    ...
    public function index(Request $request, $userId)
    {
        ...
        ->where('body', 'RLIKE', $request->search)
        ->get();

        return view('users.comments.index', compact('user'), compact('comments'));
    }
    ...
    public function edit($userId, $id)
    {
        ...
        return view('users.comments.edit', compact('user'), compact('comment'));
    }
